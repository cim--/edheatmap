...
<html>
  ...
  <body>
      ...
      <p>When Undermining, the "System Strength Penalty" and "Beyond Frontline Penalty" will reduce the personal and system merits earned if either is above Standard, with the Beyond Frontline Penalty being more severe. The scale is Standard, Moderate, High, Very High. These measures do not affect Reinforcement.</p>
	...
	<table id="refcard" data-paging="false">
		...
		<tr><td>Upload Power Malware <abbr title="Acquisition">A</abbr></td><td>Yes</td><td>No</td><td>No</td><td>No</td><td>No</td><td>If not caught</td><td>Upload Power Injection Malware to data ports</td><td>Any Power contact</td><td>Odyssey settlements in target system</td><td>Only one item can be uploaded per port. Long upload time.</td><td>None</td></tr>
		<tr><td>Complete Support Missions</td><td>Conflict only</td><td>Yes</td><td>Yes</td><td>Moderate</td><td>Some</td><td>Yes</td><td>Any mission in the “Support” category</td><td>Station in target system</td><td>n/a</td><td>Merit gain proportional to donation size for those missions, with cargo donations much more effective. Restore/reactivate Odyssey missions are very good.</td><td>Positive for mission faction</td></tr>
		...
		<tr><td>Collect Escape Pods <abbr title="Reinforcement">R</abbr></td><td>No</td><td>Yes</td><td>No</td><td>Low</td><td>No</td><td>Yes</td><td>Damaged or Occupied Escape Pods</td><td>In Target System</td><td>Target System Power Contact</td><td> Unavailable at Anarchy stations. S&R payout bonuses help with this</td><td>None</td></tr>
		...
		<tr><td>Upload Power Malware <abbr title="Undermining">U</abbr></td><td>No</td><td>No</td><td>Yes</td><td>No</td><td>No</td><td>If not caught</td><td>Upload Power Tracker Malware to data ports</td><td>Any Power contact</td><td>Odyssey settlements in target system</td><td>Only one item can be uploaded per port. Long upload time.</td><td>None</td></tr>
	    </tbody>
	</table>
